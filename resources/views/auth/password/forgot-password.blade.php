            ...
            <div class="w-full md:w-1/2">
                ...
                <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
                    ...
                    <div class="max-w-sm mx-auto w-full px-4 py-8">
                        ...
                        <h1 class="text-3xl text-gray-800 font-bold mb-6">{{ __('Mot de passe oublié') }}</h1>
                        
                        @if (session('status'))
                            <div class="bg-emerald-100 text-emerald-600 px-4 py-2 rounded mb-4">
                                {{ session('status') }}
                            </div>
                        @endif
                        
                        <p class="mb-6">{{ __('Entrez votre adresse e-mail ci-dessous. Vous recevrez un lien pour réinitialiser votre mot de passe.') }}</p>
