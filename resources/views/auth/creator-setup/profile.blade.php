                            ...
                            <div class="mb-6 lg:mb-0">
                                <div class="mb-3">
                                    <div class="flex text-sm font-medium text-gray-400 dark:text-gray-500 space-x-2">
                                        ...
                                        <span>-&gt;</span>
                                        <span class="text-violet-500">Profil</span>
                                        <span>-&gt;</span>
                        ...
                        <div class="lg:sticky lg:top-16 bg-linear-to-r from-white/30 dark:from-gray-800/30 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-700/60 lg:w-[320px] xl:w-[352px] 2xl:w-[calc(352px+80px)] lg:h-[calc(100dvh-64px)]">
                            <div class="py-8 px-4 lg:px-8 2xl:px-12">
                                <div class="max-w-sm mx-auto lg:max-w-none">
                                    <h2 class="text-2xl text-gray-800 dark:text-gray-100 font-bold mb-6">Étapes restantes</h2>
                                    <div class="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <ul class="space-y-2">
                                                <li class="flex items-center text-sm">
                                                    ...
                                                    <span class="text-gray-500 dark:text-gray-400 line-through">Configuration du fuseau horaire</span>
                                                </li>
                                                <li class="flex items-center text-sm">
                                                    <div class="w-4 h-4 rounded-full bg-violet-500 mr-3"></div>
                                                    <span class="text-gray-800 dark:text-gray-100 font-medium">Configuration du profil</span>
                                                </li>
                                                <li class="flex items-center text-sm">
                                        ...
                                        <!-- Next Steps -->
                                        <div>
                                            <div class="text-gray-800 dark:text-gray-100 font-semibold mb-4">Après la configuration</div>
                                            <div class="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                                                <p>Une fois votre profil configuré, vous pourrez :</p>
                                                <ul class="list-disc list-inside space-y-1 ml-2">
                                                    <li>Créer vos premiers types d'événements</li>
                                                    <li>Définir vos disponibilités</li>
                                                    <li>Recevoir des réservations</li>
