                    ...
                    <div class="max-w-sm mx-auto w-full px-4 py-8">
                        ...
                        <form method="POST" action="{{ route('creator.register.submit') }}" id="creatorRegisterForm">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="gaming_pseudo">{{ __('Pseudo de gaming') }} <span class="text-red-500">*</span></label>
                                    <input id="gaming_pseudo" class="form-input w-full @error('gaming_pseudo') border-red-500 @enderror" type="text" name="gaming_pseudo" value="{{ old('gaming_pseudo') }}" required />
                                    @error('gaming_pseudo')
                                        <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                                    @enderror
                                </div>
