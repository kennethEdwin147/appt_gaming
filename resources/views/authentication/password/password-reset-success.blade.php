...
<head>
  ...
  <!-- Title -->
  <title>{{ config('app.name', 'Laravel') }} - {{ __('Mot de passe réinitialisé') }}</title>
</head>
        ...
        <div class="col-md-10 col-lg-8 col-xl-5">
          ...
          <div class="card">
            <div class="card-header bg-white text-center pb-0">
              ...
              <h5 class="fs-4 mb-1">{{ __('Mot de passe réinitialisé avec succès !') }}</h5>
              <p class="small text-secondary">{{ __('Votre mot de passe a été modifié. Vous pouvez maintenant vous connecter avec votre nouveau mot de passe.') }}</p>
            </div>
