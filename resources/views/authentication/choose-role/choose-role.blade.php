                ...
                <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="text-sm">
                                Have an account? <a class="font-medium text-violet-500 hover:text-violet-600" href="{{ route('login') }}">Sign In</a>
                            </div>
                        </div>
                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <form method="POST" action="{{ route('process-role-choice') }}">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <button type="submit" class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 ml-auto">Continuer -&gt;</button>
                                </div>
                            </form>
