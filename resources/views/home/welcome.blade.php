...
<body>
  ...
  <header class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
    <nav class="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-[24px] mx-2 flex flex-wrap md:flex-nowrap items-center justify-between p-1 ps-4 md:py-0 sm:mx-auto">
      <div class="flex items-center">
        <!-- Logo -->
        <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="https://preline.co/templates/personal/index.html" aria-label="Preline">
  ...
  <main id="content">
    <div class="w-full max-w-2xl mx-auto pt-10 px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-8">
       ...
       <h1 class="mb-3 font-medium text-gray-800">
          Japanease art
        </h1>
...
<figure class="relative  transition-all duration-300 cursor-pointer ">
  <a href="#">
    <img class="rounded-lg" src="https://images.unsplash.com/photo-1676385901228-64ad87402847?q=80&w=768&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="image description">
  </a>
  <figcaption class="absolute px-4 text-lg text-white bottom-6">
      ...
      <div class="mt-8">
        ...
        <ul class="mt-5 flex flex-col gap-y-3">
          ...
          <li class="flex items-center gap-x-2.5">
            <svg class="shrink-0 size-3.5 text-gray-800" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="mt-10 sm:mt-14">
        ...
        <!-- Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-3 border-y border-gray-200 divide-y sm:divide-y-0 sm:divide-x divide-gray-200">
          <div class="sm:-ms-4 py-6 sm:px-4">
            <!-- Review -->
            <blockquote>
              <span class="text-sm text-gray-800">I'm absolutely floored by the level of care and attention to detail Eliana has put into this project and for one can guarantee that we will be a return customer.</span>
              ...
              <footer class="mt-3">
                <div class="flex items-center gap-x-2">
                  ...
                  <div class="grow">
                    <div class="text-xs text-gray-500">Josh Grazioso</div>
                  </div>
                </div>
              </footer>
            </blockquote>
          ...
          <div class="py-6 sm:px-4">
            <!-- Review -->
            <blockquote>
              <span class="text-sm text-gray-800">To say that hiring Eliana has been life-changing is an understatement. My business has tripled and I got my life back.</span>
              ...
              <footer class="mt-3">
                <div class="flex items-center gap-x-2">
                  ...
                  <div class="grow">
                    <div class="text-xs text-gray-500">Nicole Grazioso</div>
                  </div>
                </div>
              </footer>
            </blockquote>
      ...
      <div class="my-10 sm:my-14">
        ...
        <div class="space-y-3">
          <dl class="flex flex-col sm:flex-row gap-1">
            <dt class="min-w-40">
              <span class="block text-sm text-gray-500">Design Tools:</span>
            </dt>
            <dd>
              <ul>
          ...
          <dl class="flex flex-col sm:flex-row gap-1">
            <dt class="min-w-40">
              <span class="block text-sm text-gray-500">Development:</span>
            </dt>
            <dd>
              <ul>
                <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800">
          ...
          <dl class="flex flex-col sm:flex-row gap-1">
            <dt class="min-w-40">
              <span class="block text-sm text-gray-500">Design Expertise:</span>
            </dt>
            <dd>
              <ul>
                <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800">
          ...
          <dl class="flex flex-col sm:flex-row gap-1">
            <dt class="min-w-40">
              <span class="block text-sm text-gray-500">Soft Skills:</span>
            </dt>
            <dd>
              <ul>
                <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800">
      ...
      <div class="my-10 sm:my-14">
        ...
        <ul class="space-y-10">
          <li>
            ...
            <p class="mt-1">
              <a class="text-sm text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-hidden focus:decoration-2" href="#">
                Continue reading
              </a>
            </p>
          </li>
      ...
      <div class="my-10 sm:my-14">
        ...
        <!-- Input -->
        <form>
          <div class="p-1.5 flex flex-col sm:flex-row items-center gap-2 border border-gray-200 rounded-lg">
            <div class="relative w-full">
              ...
              <input type="text" id="hero-input" name="hero-input" class="py-1.5 sm:py-2 ps-9 pe-3 block w-full border-transparent rounded-lg sm:text-sm focus:border-transparent focus:ring-transparent disabled:opacity-50 disabled:pointer-events-none" placeholder="Enter your email">
            </div>
            <a class="w-full sm:w-auto whitespace-nowrap py-2 px-2.5 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-md border border-transparent bg-gray-800 text-white hover:bg-gray-900 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
              Join
      ...
      <div class="flex flex-wrap justify-between items-center gap-2">
        ...
        <ul class="flex flex-wrap items-center">
          <li class="inline-block relative pe-4 text-xs last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-1.5 before:-translate-y-1/2 before:size-[3px] before:rounded-full before:bg-gray-400">
            <a class="text-xs text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-hidden focus:decoration-2" href="#">
              X (Twitter)
            </a>
          </li>
          <li class="inline-block relative pe-4 text-xs last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-1.5 before:-translate-y-1/2 before:size-[3px] before:rounded-full before:bg-gray-400">
